  ...
  <div class="center-block w-xxl w-auto-xs p-y-md">
    ...
    <div class="p-a-md box-color r box-shadow-z1 text-color m-a">
      ...
      <form target="" method="post" name="form">
        ...
        <button type="submit" class="btn primary btn-block p-x-md">Logiarse</button>
      </form>
    ...
    <div class="p-v-lg text-center">
      ...
      <div>¿No tiene una cuenta? <a ui-sref="access.signup" href="register.php" class="text-primary _600">Regístrate</a></div>
    </div>
  </div>
