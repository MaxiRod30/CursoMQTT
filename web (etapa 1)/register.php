...
if( isset($_POST['email']) && isset($_POST['password']) && isset($_POST['password_r'])) {
  ...
  if ($password==$password_r){
    ...
    if ($count == 0){
      ...
      $consulta = $conn->query("INSERT INTO `users` (`users_email`, `users_password`) VALUES ('".$email."', '".$password."');");
  ...
  <div class="center-block w-xxl w-auto-xs p-y-md">
    ...
    <div class="p-a-md box-color r box-shadow-z1 text-color m-a">
      <div class="m-b text-sm">
        Regístrese en su cuenta de IoT!
      </div>
...
<br>
    <div class="p-v-lg text-center">
      <div>Si ya tienes una cuenta! <a ui-sref="access.signin" href="login.php" class="text-primary _600">Logiate</a></div>
    </div>
  </div>
